                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <th scope="row">{{$key+1}}</th>
                                ...
                                <td><a href="{{ route('pizza.edit', $pizza->id) }}"><button class="btn btn-primary">Edit</button></td>
                                <td><button class="btn btn-danger" data-toggle="modal" data-target="#del{{ $pizza->id }}">Delete</button></td>
                            </tr>

                            <!-- Modal -->
                            <div class="modal fade" id="del{{ $pizza->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
